...
P = pd.read_csv('数据集/2019-nCoV-bd-global-20200301.csv')
P = P['confirmed'][155:246]
P = np.array(P)
...
# 近期情况预测
tomorrow = [95,96,97,98,99,100,101,102,103,104]
